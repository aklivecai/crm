...
$this->breadcrumbs=array(
	...
	$tags = array( 
        ...
        'us_launch',
        'note',
        'time_stocked' => array('name'=>'time_stocked', 'value'=>Tak::timetodate($model->time_stocked)),
...
<div class="span5">
 ...
 <?php $this->widget('bootstrap.widgets.TbListView', array(
			...
			'template'=>'<table class="table"> <thead> <tr> <th>产品名字</th> <th>产品规格</th> <th>材料</th> <th>单位</th> <th>数量</th> <th>备注</th> </tr> </thead> <tbody>{items}</tbody> </table>',
