...
/* @var $data AddressGroups */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('address_groups_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->address_groups_id), array('view', 'id'=>$data->address_groups_id)); ?>
	<br />
